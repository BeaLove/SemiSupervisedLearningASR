...
class Corpus:
    ...
    def __init__(self, transcription_dir, audio_dir):
        ...
        self.audio = os.path.realpath(audio_dir)
        ...
        # a directory tree. 
        for directory, _subdirs, files in os.walk(self.audio):
            for f in files:
    ...
    def get_audiofilename(self, utterance):
        ...
        audfile = os.path.join(self.audio, utterance + ".wav")
        return audfile
