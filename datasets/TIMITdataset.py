...
class TimitDataset(Dataset):
    ...
    def __init__(self, csv_file, root_dir, pre_epmh, num_ceps, n_fft, frame_size, frame_shift):
        ...
        self.mergedPhones2int = {'iy': 0, 'ih': 1, 'eh': 2, 'ae': 3, 'ix': 4, 'ax': 5, 'ah': 6, 'uw': 7, 'ux': 7,
                                 ...
                                 'dcl': 45, 'gcl': 45, 'epi': 46, 'sil': 47, 'h#': 47, '#h': 47, 'pau': 47}
...
dataset = TimitDataset(csv_file=csv_filename, root_dir=root_dir, pre_epmh=0.97, num_ceps=13, n_fft=512, frame_size=20, frame_shift=10)
